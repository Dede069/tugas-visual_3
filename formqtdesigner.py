...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NAMA.setGeometry(QtCore.QRect(80, 50, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(26)
        self.NAMA.setFont(font)
        self.NAMA.setObjectName("NAMA")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(80, 130, 171, 51))
        font = QtGui.QFont()
        font.setPointSize(26)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(300, 40, 281, 71))
        self.textEdit.setObjectName("textEdit")
        self.textEdit_2 = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit_2.setGeometry(QtCore.QRect(300, 130, 281, 71))
...
"color:white;")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(300, 280, 161, 41))
